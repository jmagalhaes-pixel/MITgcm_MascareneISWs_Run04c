...
C modifications made from the original file which comes form the IW tutorial
C
...
C o Maarten's Buijsman body forcing terms that will enter via external_forcing.F in .../code.		!JM changes JM changes JM changes
